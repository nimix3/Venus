<?php
// MiqroDB Class Library V.1 By Xesau and edited by NIMIX3 for VENUS FRAMEWORK that is Under MIT License.
// A useful class that helps you with querying MySQL in PHP easier. https://github.com/Xesau/MiqroDB is under MIT License.
...
class MiqroDB
{
    ...
    {
        if( $sql instanceof MiqroBuilder )
            $sql = $sql->__toString();

<?php
// Router Class Library V.1 By Xesau and edited by NIMIX3 for VENUS FRAMEWORK that is Under MIT License.
// Xesau\Router is a one-file PHP router https://github.com/Xesau/Router is under Apache2 License.

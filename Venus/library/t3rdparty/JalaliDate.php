<?php
// JalaliDate Class Library V.1 By Reza Gholampanahi and edited by NIMIX3 for VENUS FRAMEWORK that is Under MIT License.
// Hijri_Shamsi,Solar(Jalali) Date and Time Functions http://jdf.scr.ir is under GNU/LGPL License.
...
class JalaliDate
{
	...
	public static function gregorian_to_jalali($g_y,$g_m,$g_d,$mod=''){
		$g_y=Jdf::tr_num($g_y); $g_m=Jdf::tr_num($g_m); $g_d=Jdf::tr_num($g_d);
	 $d_4=$g_y%4;

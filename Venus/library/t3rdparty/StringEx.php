<?php
// StringEx Class Library V.1 By danielstjules and edited by NIMIX3 for VENUS FRAMEWORK that is Under MIT License.
// Stringy: A PHP string manipulation library with multibyte support https://github.com/danielstjules/Stringy is under MIT License.
...
class StringEx implements Countable, IteratorAggregate, ArrayAccess
{
    protected $str;
    protected $encoding;
...
if (!function_exists('s')) {
    ...
    {
        return new StringEx($str, $encoding);
    }
}